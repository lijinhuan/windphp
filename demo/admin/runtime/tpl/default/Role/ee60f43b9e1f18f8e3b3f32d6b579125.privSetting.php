...
<link href="<?php echo $this->addquote($system_conf['css_url']); ?>jquery.treeTable.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $this->addquote($system_conf['js_url']); ?>jquery.treetable.js"></script>
