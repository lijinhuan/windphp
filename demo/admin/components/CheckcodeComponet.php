...
use Windphp\Windphp;
class CheckcodeComponet extends IComponent {
	...
	function __construct() {
		$rand = rand(0,1);
		if($rand==0) {
			$this->font = Windphp::getRootPath().'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'elephant.ttf';
		} else {
			$this->font = Windphp::getRootPath().'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'Vineta.ttf';
		}
